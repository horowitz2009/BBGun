...
public class MainFrame extends JFrame {
      ...
      addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          if (e.getButton() == MouseEvent.BUTTON1) {
            if (_startPoint == null) {
              ...
              // LOGGER.info("clicked twice " + e.getButton() + " (" + e.getX() + ", " + e.getY() + ")");
              setVisible(false);
        ...
        public void mouseReleased(MouseEvent e) {
          ...
          if (inDrag && _endPoint != null && _startPoint != null) {
            // LOGGER.info("end of drag " + e.getButton() + " (" + e.getX() + ", " + e.getY() + ")");
            inDrag = false;
            setVisible(false);
            LOGGER.info("AREA: " + _rect);
            // HMM
  ...
  private void record() {
    try {
      ...
      if (_scanner.isOptimized()) {
        captureDialog.setBounds(_scanner.getTopLeft().x, _scanner.getTopLeft().y, _scanner.getGameWidth(), _scanner.getGameHeight());
      } else {
  ...
  private List<Pixel> scanMany(String filename, boolean click) throws RobotInterruptedException, IOException, AWTException {
